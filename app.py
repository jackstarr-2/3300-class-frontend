...
app.config["SECRET_KEY"] = "fjhasngojipklwhn9fgvjn"

CORS(app)

# Get this URL from the Azure Overview page of your API web app
api_url = "https://starr-api-westeurope-bsf8hhd5bkevhkgq.westeurope-01.azurewebsites.net"  # base url for API endpoints
